...
def tuned_mm(mat1, mat2, *, layout=None):
    ...
    if m * n != 0 and use_cutlass_template(layout):
        cutlass_template = CUTLASSGemmTemplate([mat1, mat2], layout, alpha=1, beta=0, can_fuse_epilogue=False)
        ...
        cutlass_template_evt = CUTLASSGemmTemplate([mat1, mat2], layout, alpha=1, beta=0, can_fuse_epilogue=True)
